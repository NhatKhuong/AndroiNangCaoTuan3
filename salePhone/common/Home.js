...
export default function Home({navigation}) {
  ...
  var a = '../imgs/vsmart_live_xanh1.png';
  var url = require(a);
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={{marginTop:30}}>
              ...
              <View style={{marginTop:20}}>
                <Button variant="outlined" title="4 Màu - Chọn Màu" color="#d4ac2d" onPress={handlerPress}/>
              </View>
              <View style={{marginTop:80}}>
                <Button title="Mua" color="error" onPress={handlerPress} />
              </View>
            </View>
        </View>
    );
